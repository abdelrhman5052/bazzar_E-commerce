...
const CartItem = () => {
  ...
  return (
    <div className="w-2/3 pr-10">
          ...
          >
            <div className="flex items-center gap-2">
              <MdOutlineClose
                ...
                className="text-xl ext-gray-600 hover:text-red-600 cursor-pointer duration-300"
              />
              <img
                src={item.image}
                alt="productImg"
      ...
      <button onClick={() => dispatch(resetCart()) & toast.error("your cart is Empty") } className="bg-red-500 text-white mt-8 ml-7 py-1 px-6 hover:bg-red-800 duration-300 cursor-pointer">
        Reset Cart
      </button>

       <Link to="/">
        <button className="mt-8 ml-7 flex items-center gap-1 text-gray-700 hover:text-black duration-300 cursor-pointer">
            <span>
                <HiOutlineArrowLeft />
            </span>
            go shopping
